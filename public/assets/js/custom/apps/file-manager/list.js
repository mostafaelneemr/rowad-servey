...
var KTFileManagerList = function () {
    ...
    const initDropzone = () => {
        ...
        var formAction = $('#kt_modal_upload_form').attr('action');
        var myDropzone = new Dropzone(id, { // Make the whole body a dropzone
            url: formAction, // Set the url for your upload script location
            autoDiscover: false,
            uploadMultiple: true,
            parallelUploads: 10,
            maxFiles: 10,
            ...
            init: function() {
                ...
                this.element.querySelector(".dropzone-upload").addEventListener("click", function(e) {
                ...
                this.on("sendingmultiple", function(files,xhr,data) {
                    ...
                    for (let file of files) {
                        data.append("fileTitle[]", document.getElementById( file.upload.uuid).value);
                    }
                    console.log(data);
                });
                this.on("successmultiple", function(files, response) {
                    console.log(files,' success multiple');
                    // Gets triggered when the files have successfully been sent.
                    // Redirect user or notify of success.
                });
                this.on("errormultiple", function(files, response) {
                    console.log(files,' errormultiple');
        ...
        myDropzone.on("addedfile", function (file) {
            ...
            let input = file.previewElement.querySelector('input')
