...
var KTModalNewTicket = function () {
	...
	var initForm = function() {
		...
		// Due date. For more info, please visit the official plugin web: https://flatpickr.js.org/
		...
		// Ticket user. For more info, plase visit the official plugin web: https://select2.org/
        $(form.querySelector('[name="user"]')).on('change', function() {
            // Revalidate the field when an option is chosen
            validator.revalidateField('user');
        });

		// Ticket status. For more info, plase visit the official plugin web: https://select2.org/
