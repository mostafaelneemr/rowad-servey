...
@section('content')
    ...
    <!--begin::Form-->
    {!! Form::open(['id'=>'main-form','onsubmit' =>  isset($result) ? 'FormSubmit("'.route('system.about.update',$result->id).'");return false;':'FormSubmit("'.route('system.about.store') .'");return false;','method' => isset($result) ?  'PATCH' : 'POST']) !!}
