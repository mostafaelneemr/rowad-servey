...
@section('content')
    ...
    <!--begin::Form-->
    {!! Form::open(['id'=>'main-form','onsubmit' =>  isset($result) ? 'FormSubmit("'.route('system.category.update',$result->id).'");return false;':'FormSubmit("'.route('system.category.store') .'");return false;','method' => isset($result) ?  'PATCH' : 'POST']) !!}
