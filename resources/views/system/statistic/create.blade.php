...
@section('content')
    ...
    <!--begin::Form-->
    {!! Form::open(['id'=>'main-form','onsubmit' =>  isset($result) ? 'FormSubmit("'.route('system.statistic.update',$result->id).'");return false;':'FormSubmit("'.route('system.statistic.store') .'");return false;','method' => isset($result) ?  'PATCH' : 'POST']) !!}
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade" id="topic_data" role="tabpanel">
                    ...
                    <div class="row gx-10 ">
                        ...
                        <div class="col-lg-6">
                            {{ label( __('number'),'required') }}
                            <div class="mb-5">
                                {{ Form::text('number',isset($result) ? $result->number : '',
                                    ['id' => 'number',   'class' => 'form-control form-control-solid'  ]
                                ) }}
                                <div class="invalid-feedback" id="number-form-error"></div>
                            </div>
                        </div>
