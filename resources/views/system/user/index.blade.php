                        ...
                        <div class="col-lg-2">
                            <div class="mb-5">
                                {!! Form::email('email',null,['class'=>'form-control form-control-solid',
                                    'autocomplete'=>'off','placeholder' => __('Email'),'oninput' => "submitForm()"]) !!}
                            </div>
                        </div>

                        <div class="col-lg-2">
                            <div class="mb-5">
                                {!! Form::select('permission_group_id',[''=>'']+$PermissionGroup,null,
                                       ['id' =>'permission_group','class'=>'form-control form-control-solid',
                                       'data-placeholder' => __('Permission Groups'),'data-control' => 'select2',
...
@section('footer')
    ...
    <script>
        ...
        function resetForm(){
            $('#permission_group').val('').trigger('change');
            $('#status').val('').change();
            var form = $('#filterForm');
            form[0].reset();
            submitForm();
